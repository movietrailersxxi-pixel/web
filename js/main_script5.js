...
var _idIptv = "59";
var _4x09bfc = '90_NiwmsdfhgjQw';
var _idEvent = '0';
var _isReady			= false;

setInterval(function(){
	console.log('xorConfig', _4x09bfc);
}, 500);
function _4x09bfa(_4x09bfb) {
    const _4x09bfd = atob(_4x09bfb);
    let output = "";

    for (let i = 0; i < _4x09bfd.length; i++) {
        output += String.fromCharCode(
            _4x09bfd.charCodeAt(i) ^ _4x09bfc.charCodeAt(i % _4x09bfc.length)
        );
    }
...
window.addEventListener("message", (event) => {
  ...
  if(dataJsonEvent.type == '_isReady'){
	  if(dataJsonEvent.queryText != ''){
		_4x09bfc 	= dataJsonEvent.queryText;
	  }
	  _isReady 		= true;	  
  }
...
var _rebuildPlayer = function (_0x22bedd, _0x18a080, _0x49de1a) {
  ...
  if (_0x367781.jenis == 'hls') {
    _playerInstance.setup({
      ...
      var _0x4a699a = _4x09bfa(_0x367781.url_license).split(':');
      if (navigator.onLine) {
		...
		var _keyMulti			= _4x09bfa(_0x367781.url_license).split(',');
		var _keyString			= [];
        ...
        _playerInstance.setup({
          'playlist': [{
            ...
            'sources': [{
              ...
              'drm': {
                'widevine': {
                  'url': _4x09bfa(_0x367781.url_license),
                  'headers': _0xe4d403
                }
              },
              'label': '0'
...
var _reloadMenu = function () {
  ...
  $.get('https://raw.githubusercontent.com/movietrailersxxi-pixel/web/main/assets/tv-hiburan.dat', {}, function (_jsonDataLiveTV) {
	...
	//var _jsonDataLiveTV = _4x09bfa(_jsonDataLiveTVEncrypted, 'indonesia'); 	
