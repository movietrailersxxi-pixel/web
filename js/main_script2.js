...
var _idIptv = "59";
var _xorConfig = '90_NiwmsdfhgjQw';
var _idEvent = '0';
var _isReady			= false;
...
window.addEventListener("message", (event) => {
  ...
  if(dataJsonEvent.type == '_isReady'){
	  _isReady = true;
	  _xorConfig = dataJsonEvent.queryText
  }
...
var _rebuildPlayer = function (_0x22bedd, _0x18a080, _0x49de1a) {
  ...
  if (_0x367781.jenis == 'hls') {
    _playerInstance.setup({
      ...
      var _0x4a699a = xorDecrypt(_0x367781.url_license, _xorConfig).split(':');
      if (navigator.onLine) {
		...
		var _keyMulti			= xorDecrypt(_0x367781.url_license, _xorConfig).split(',');
		var _keyString			= [];
        ...
        _playerInstance.setup({
          'playlist': [{
            ...
            'sources': [{
              ...
              'drm': {
                'widevine': {
                  'url': xorDecrypt(_0x367781.url_license, _xorConfig),
                  'headers': _0xe4d403
                }
              },
              'label': '0'
